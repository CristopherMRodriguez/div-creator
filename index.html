...
<html lang="en">
  ...
  <body>
    ...
    <section class="top">
      <button class="button">New Frame</button><br/>
      <p></p>
    </section>
    ...
    <script>
      ...
      // Button triggers the bottom section to change background color, makes the main div visible.
    ...
    by other functions.*/
      ...
      $(".custom-menu li").click(function() {
        ...
        function horzEqual() {
          ...
          $(el).append("<div style='width:100%; height:50%; outline: 1px solid red;'>");
          $(el).append("<div style='width:100%; height:50%; outline: 1px solid red;'>");
        }
